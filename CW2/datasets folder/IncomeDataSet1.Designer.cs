...
namespace CW2.datasets_folder {
    ...
    public partial class IncomeDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/IncomeDataSet1.xsd";
        ...
        public partial class IncomeDataTable : global::System.Data.TypedTableBase<IncomeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public IncomeRow AddIncomeRow(int Id, decimal amount, string type, string Date) {
...
namespace CW2.datasets_folder.IncomeDataSetTableAdapters {
    ...
    public partial class IncomeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Income] WHERE (([Id] = @Original_Id) AND ((@IsNull_amount = 1 " +
                "AND [amount] IS NULL) OR ([amount] = @Original_amount)) AND ((@IsNull_type = 1 A" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Income] SET [Id] = @Id, [amount] = @amount, [type] = @type, [Date] = @Date WHERE (([Id] = @Original_Id) AND ((@IsNull_amount = 1 AND [amount] IS NULL) OR ([amount] = @Original_amount)) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)));
SELECT Id, amount, type, Date FROM Income WHERE (Id = @Id)";
        ...
        public virtual int Fill(IncomeDataSet.IncomeDataTable dataTable) {
        ...
        public virtual IncomeDataSet.IncomeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            IncomeDataSet.IncomeDataTable dataTable = new IncomeDataSet.IncomeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IncomeDataSet.IncomeDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(IncomeDataSet dataSet) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<decimal> Original_amount, string Original_type) {
        ...
        public virtual int Insert(int Id, global::System.Nullable<decimal> amount, string type, string Date) {
        ...
        public virtual int Update(int Id, global::System.Nullable<decimal> amount, string type, string Date, int Original_Id, global::System.Nullable<decimal> Original_amount, string Original_type) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<decimal> amount, string type, string Date, int Original_Id, global::System.Nullable<decimal> Original_amount, string Original_type) {
            return this.Update(Original_Id, amount, type, Date, Original_Id, Original_amount, Original_type);
        }
    }
