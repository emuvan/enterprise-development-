...
namespace CW2.datasets_folder {
    ...
    public partial class ContactDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ContactRow AddContactRow(int Id, string Name, int Phonenumber) {
        ...
        public partial class ContactRow : global::System.Data.DataRow {
            ...
            public int Phonenumber {
                get {
                    try {
                        return ((int)(this[this.tableContact.PhonenumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace CW2.datasets_folder.ContactDataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Contact] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 A" +
                "ND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phonenumber = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contact] ([Id], [Name], [Phonenumber]) VALUES (@Id, @Name, @Ph" +
                "onenumber);\r\nSELECT Id, Name, Phonenumber FROM Contact WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contact] SET [Id] = @Id, [Name] = @Name, [Phonenumber] = @Phonenumber WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Phonenumber = 1 AND [Phonenumber] IS NULL) OR ([Phonenumber] = @Original_Phonenumber)));
SELECT Id, Name, Phonenumber FROM Contact WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CW2.Properties.Settings.Default.ContactConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Phonenumber FROM dbo.Contact";
        ...
        public virtual int Fill(ContactDataSet.ContactDataTable dataTable) {
        ...
        public virtual ContactDataSet.ContactDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactDataSet.ContactDataTable dataTable = new ContactDataSet.ContactDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactDataSet.ContactDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, global::System.Nullable<int> Original_Phonenumber) {
        ...
        public virtual int Insert(int Id, string Name, global::System.Nullable<int> Phonenumber) {
        ...
        public virtual int Update(int Id, string Name, global::System.Nullable<int> Phonenumber, int Original_Id, string Original_Name, global::System.Nullable<int> Original_Phonenumber) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Phonenumber, int Original_Id, string Original_Name, global::System.Nullable<int> Original_Phonenumber) {
